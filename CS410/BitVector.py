...
class BitVector( object ):                                           #(A1)
    ...
    def __init__( self, *args, **kwargs ):                           #(A2)
        ...
        if 'filename' in kwargs:filename=kwargs.pop('filename')#(A6)
        if 'fp' in kwargs:           fp = kwargs.pop('fp')     #(A7)
        if 'size' in kwargs:       size = kwargs.pop('size')   #(A8)
        if 'intVal' in kwargs:   intVal = kwargs.pop('intVal') #(A9)
